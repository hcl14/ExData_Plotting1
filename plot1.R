...
## I know about the way that uses library(sqldf) but it becomes complicated for me to deal with 
...
m[,2]<-as.POSIXct(mapply(paste, m[,1], m[,2]), format="%d/%m/%Y%H:%M:%S") ## we combine string values 
##from first two colums
